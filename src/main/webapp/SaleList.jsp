...
<form action="pc/gopage" method="post">
			搜索 ：销售订单编号：<input type="text" name="saleid" value="" ></br>
				...
				地址查询：<input type="text" name="sendaddr" value="" /></br>
...
<table id="tab" border="1" bordercolor="red">
			...
			<c:forEach items="${lss }" var="l">
				<tr align="center">
					...
					<td><input type="button" value="送审" onclick="songshen(${l.sale.saleid})" /></td>
					</c:if>
				</tr>
			</c:forEach>
		</table>
